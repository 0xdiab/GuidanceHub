...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active" aria-current="page">Create a new mentee</li>
@endsection
                ...
                <div class="col-7">
                    ...
                    <div class="card card-form card-data">
                        ...
                        <div class="card-header">
                            <h4 class="heading m-0 p-2">Create a new mentee</h4>
                        </div>
                        {{-- card-body --}}
                        <div class="card-body">
                            <div class="form-content">
                                <form action="{{ route('dashboard.mentees.store') }}" method="POST">
                                    @csrf
                                    <!-- Name -->
                                    <div class="mt-4">
